export const availableFeatures = [
    ...
    { id: 'procedures', label: 'Procedures Management', href: '/procedures' },
    { id: 'inventory', label: 'Inventory Management', href: '/inventory' },
    { id: 'supplier', label: 'Supplier Management', href: '/supplier' },
    { id: 'billing', label: 'Billing & Invoicing', href: '/billing' },
